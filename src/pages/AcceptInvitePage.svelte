    ...
    {:else if registered}
      <section class="surface-panel p-8 text-center sm:p-10">
        ...
        <p class="mt-3 text-sm leading-relaxed text-muted-foreground">
          Your access to {inviteDetails?.businessName} is ready. Sign in with {inviteDetails?.email}
          to continue.
        </p>
      ...
      <div class="mb-10 flex items-center justify-center">
        <div class="flex min-w-0 items-center gap-3">
          ...
          <span
            ...
            >{inviteDetails.businessName}</span
          >
        </div>
      </div>
      <section class="surface-panel p-8 sm:p-10">
        <div class="mb-8 text-center">
          ...
          <h1 class="mt-3 font-heading text-2xl font-bold">
            Join {inviteDetails.businessName}
          </h1>
    ...
    {:else}
      <section class="surface-panel p-8 text-center sm:p-10">
        ...
        <p class="mt-3 text-sm text-muted-foreground">
          {fetchError || "This invite may have expired or already been used."}
        </p>
        <Button
          type="button"
          variant="outline"
