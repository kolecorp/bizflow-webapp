<script lang="ts">
  ...
  const pageTitles: Record<string, string> = {
    ...
    "/extensions/vtu/deployment": "VTU Customer Deployment",
    "/extensions/vtu/provider": "VTU Provider Setup",
    "/extensions/vtu/purchase": "New VTU Purchase",
    "/extensions/vtu/transactions": "VTU Transactions",
    "/extensions/vtu/pricing": "VTU Pricing",
